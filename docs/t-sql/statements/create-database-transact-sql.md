...
|版本|默认值|
|-------------|--------------------|
|从 [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] 开始|数据 64 MB。 日志文件 64 MB。|
