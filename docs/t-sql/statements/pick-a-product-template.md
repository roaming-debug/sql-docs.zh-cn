...
description: Transact-SQL 参考文档的模板文章
ROBOTS: NOINDEX
ms.custom: ''
ms.date: 05/22/2019
ms.prod: sql
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        [SQL 数据库](pick-a-product-template.md?view=azuresqldb-current&preserve-view=true)
    :::column-end:::
    :::column:::
        [SQL 托管实例](pick-a-product-template.md?view=azuresqldb-mi-current&preserve-view=true)
    :::column-end:::
    :::column:::
