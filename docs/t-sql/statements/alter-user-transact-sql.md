...
> 此选项只能在包含数据库中指定，且只能用于包含的用户。
 ...
 ALLOW_ENCRYPTED_VALUE_MODIFICATIONS = [ ON | **OFF** ]  **适用于**：[!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] 和更高版本 [!INCLUDE[ssSDS](../../includes/sssds-md.md)]。
