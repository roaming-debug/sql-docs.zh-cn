...
了解如何使用 [SQL Server 机器学习服务](../sql-server-machine-learning-services.md)在 [Azure Data Studio](../../azure-data-studio/what-is-azure-data-studio.md) 笔记本中运行 Python 和 R 脚本。 Azure Data Studio 是一种跨平台数据库工具。
