...
## <a name="see-also"></a>另请参阅  
 ...
 [报表生成器入门](https://www.databasejournal.com/features/mssql/sql-server-report-builder-3.0.html)   
 [使用 Report Builder 1.0 设计和实现报表](/previous-versions/sql/sql-server-2008/ms159750(v=sql.100))  
