...
# <a name="technical-reference-ssrs"></a>技术参考 (SSRS)
 ...
 ![小文件文件夹图标](/analysis-services/analysis-services/media/filefolder-small.png "小文件文件夹图标") **报表服务器命令提示实用工具**  
 ...
 ![小文件文件夹图标](/analysis-services/analysis-services/media/filefolder-small.png "小文件文件夹图标") **Reporting Services WMI 提供程序类库**  
