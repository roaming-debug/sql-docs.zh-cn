...
>   
>  此外，MDAC 2.8) 中 (的远程处理代理/存根 dll 无法调用 Native Client 中的 **ISSAsynchStatus** 接口 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] 。 ISSAsynchStatus 接口不通过远程公开  。  
>   
