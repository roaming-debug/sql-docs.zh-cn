...
-   **ISupportErrorInfo**  
 ...
 特定于访问接口的属性 SSPROP_FASTLOADOPTIONS、SSPROP_FASTLOADKEEPNULLS 和 SSPROP_FASTLOADKEEPIDENTITY 控制 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client OLE DB 访问接口大容量复制行集的行为。 在 _rgPropertySets_**IOpenRowset** 参数成员的 *rgProperties* 成员中指定这些属性。  
