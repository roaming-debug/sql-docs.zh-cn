---
description: 'SQL Server Native Client (属性中 OLE DB Table-Valued 参数类型支持) '
title: 'OLE DB Table-Valued 参数类型 (属性) '
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "104753467"
---
# <a name="ole-db-table-valued-parameter-type-support-in-sql-server-native-client-properties"></a>SQL Server Native Client (属性中 OLE DB Table-Valued 参数类型支持) 
