...
或者从 [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] SP1（[查询提示](../../t-sql/queries/hints-transact-sql-query.md#use_hint) `USE HINT ('FORCE_LEGACY_CARDINALITY_ESTIMATION')`）开始。
...
**查询存储：** 从 [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] 开始，查询存储是用于检查查询性能的一种方便的工具。 在 [!INCLUDE[ssManStudio](../../includes/ssManStudio-md.md)] 中的数据库节点下的对象资源管理器中，当查询存储启用时，显示“查询存储”节点   。  
