...
|name|**sysname**|审核的名称。 与 " **sys.server_audits** 目录" 视图中的 "**名称**" 字段相同。|  
...
|**event_session_address**|**varbinary(8)**|与审核关联的扩展事件会话的地址。 与 **sys.dm_xe_sessions** 目录视图相关。|  
