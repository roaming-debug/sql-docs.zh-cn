...
DMV 对于 SQL 数据库或 Azure Synapse Analytics 是唯一的。   
...
:::row:::
    ...
    :::column:::
        ...
        [Azure SQL Database &#40;sys.dm_db_objects_impacted_on_version_change&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-db-objects-impacted-on-version-change-azure-sql-database.md)
    :::column-end:::
:::row-end:::
