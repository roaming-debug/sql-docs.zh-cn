...
ms.locfileid: "98094345"
---
# <a name="systrace_subclass_values-transact-sql"></a>sys.trace_subclass_values (Transact-SQL)
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  **Sys.trace_subclass_values** 目录视图包含一个命名列值列表。 在 [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]的给定版本中，这些子类值不变。  
...
|列名称|数据类型|说明|  
|-----------------|---------------|-----------------|  
|**trace_event_id**|**smallint**|跟踪事件的 ID。 此参数也在 **sys.trace_events** 目录视图中。|  
|**trace_column_id**|**smallint**|用于枚举的跟踪列的 ID。 此参数也在 **sys.trace_columns** 目录视图中。|  
