...
|**query_capture_mode_desc**|**nvarchar(60)**|查询存储实际捕获模式的文本说明：<br /><br /> 所有 (默认值都 [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]) <br /><br /> **自动** () 的默认值 [!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)]<br /><br /> NONE|  
