...
ms.locfileid: "100105640"
---
### <a name="transactional--snapshot-replication-compatibility-matrix"></a>事务和快照复制兼容性矩阵
...
### <a name="merge-replication--compatibility-matrix"></a>合并复制兼容性矩阵
| **发布者**   | **分发服务器** | **订阅服务器** |
| :------------   | :-------------- | :------------- |
