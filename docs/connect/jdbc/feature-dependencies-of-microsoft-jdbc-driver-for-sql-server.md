...
- JDBC 驱动程序版本 9.2.0 - 依赖项版本：Azure-keyvault（版本 4.2.1）、Azure-identity（版本 1.1.3）及其依赖项（[示例应用程序](azure-key-vault-sample-version-9.2.md)）
...
- JDBC 驱动程序版本 9.2.0 - 依赖项版本：Azure-identity（版本 1.1.3）及其依赖项。
