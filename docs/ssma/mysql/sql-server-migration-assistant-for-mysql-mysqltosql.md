...
|部分|说明|
|-----------|---------------|
|[SSMA for MySQL 中的新增功能](./what-s-new-in-ssma-for-mysql-mysqltosql.md)|此版本的 SSMA for MySQL 中的新增功能|  
...
|[获取 SSMA 以获取 MySQL 援助](../sql-server-migration-assistant.md)|提供有关获取其他帮助的信息。|