...
|部分|说明|
|-----------|---------------|
|[SSMA for Oracle 中的新增功能](./what-s-new-in-ssma-for-oracle-oracletosql.md)|此版本的 SSMA for Oracle 中的新增功能|  
...
|[获取 Oracle 帮助的 SSMA](../sql-server-migration-assistant.md)|提供有关获取其他帮助的信息。|