...
description: 具有 SQL Server 服务解决方案的第三方合作伙伴列表，这些解决方案可为 SQL Server 服务提供高可用性和灾难恢复。
ms.topic: conceptual
